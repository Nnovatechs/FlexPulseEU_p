...
const kpis = [
  ...
  kpi({
    id: "synthetic_ranking_recovery_rate",
    category: "Synthetic cohort recovery",
    label: "Ranking recovery rate",
    value: rateFromRow(syntheticReport, "ranking_recovery"),
    threshold: 1,
    source: "synthetic-cohorts/latest/report.json",
  }),
  kpi({
    id: "synthetic_contradiction_recovery_rate",
    category: "Synthetic cohort recovery",
    label: "Contradiction recovery rate",
    value: syntheticReport.contradiction_recovery_rate,
    threshold: 1,
    source: "synthetic-cohorts/latest/report.json",
  }),
  kpi({
    id: "synthetic_residual_contradiction_rate",
    category: "Synthetic cohort recovery",
    label: "Residual contradiction rate",
    value: syntheticReport.contradiction_rate,
    threshold: 0,
    source: "synthetic-cohorts/latest/report.json",
    direction: "lte",
  }),
